...
import { getName, searchPokemon, backToHome, globalFilter, filterApi, filterDb, filterByTypes, resetFilters, orderByAttack, orderByName } from '../../redux/actions';
	...
	return (
		<div className='container__searchBar'>
			...
			<div className='form__searchBar'>
				<div className="checked__filter__container">
					<div className="checked__searchBar">
						...
						<div className="check__info__searchBar">
							<label htmlFor="" className='label__searchBar'>All Pokemons</label>
							<input type="checkBox" value='all' checked={globalFiltered.all} onChange={handleOnChange} className='check__searchBar' />
						</div>
						<div className="check__info__searchBar">
							<label htmlFor="" className='label__searchBar'>Api Pokemons</label>
							<input type="checkBox" value='api' checked={globalFiltered.api} onChange={handleOnChange} className='check__searchBar' />
						</div>
						<div className="check__info__searchBar">
							<label htmlFor="" className='label__searchBar'>DB Pokemons</label>
							<input type="checkBox" value='db' checked={globalFiltered.db} onChange={handleOnChange} className='check__searchBar' />
						</div>
					</div>
					<div className='filter__searchBar'>
						<h2 className='title__filter__searchBar'>Filter</h2>
						{/* <select name="" id="" className='select__searchBar'>
							<option value="" className='option__searchBar'>Filter by type</option>
						</select> */}
						...
						<select name='names' className='select__searchBar' onChange={handleChange}>
							...
							<option value="A" className='option__searchBar'>Asc</option>
							<option value="D" className='option__searchBar'>Des</option>
						</select>
				...
				<button onClick={handleClick} className='btn__create'>Create</button>
				<button className='btn__create' onClick={handleOnClick}>Home</button>
			</div>
		</div>
	);
};
